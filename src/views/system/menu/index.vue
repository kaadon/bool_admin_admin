                    ...
                    <el-col :span="12">
                        <el-form-item label="添加菜单:" prop="routeFormSwitch">
                            <el-switch v-model="routeFormSwitch" active-color="#13ce66" :active-value="1"
                                       :inactive-value="0" active-text="添加" inactive-text="不添加"
                            ></el-switch>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
...
<script>
import {addMenu, delMenu, getMenu, listMenu, statusMenu, updateMenu} from '@/api/system/menu'
...
export default {
    ...
    methods: {
        ...
        handleStatusChange(row) {
            ...
            this.$confirm(`确认要"${text}""${row.title}"菜单吗?${row.status}`, '警告', {
